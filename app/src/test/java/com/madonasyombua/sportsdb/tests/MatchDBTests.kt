...
class MatchDBTests {
    ...
    fun databaseCreated() {
        ...
        sportsDataBase = Room.inMemoryDatabaseBuilder(RuntimeEnvironment.systemContext, SportDB::class.java) //this is just allowed here for testing
                ...
                .build()
        matchEntity = MatchEntity(1,"PremierLeague","07:12:2020","2:11","Manchester","Arsenal",
        "0","3","1111","2222")
    }
    ...
    fun insertItemsInTheDB() {
        ...
        assertEquals("PremierLeague", sportsDataBase?.getMatchDao()?.getAllMatches()?.get(0)?.leagues)
    }
